            ...
            <div class="row">
               <div class="col-md-10"></div>
                <div class="col-2 mb-3">
                    <button style="width: 100%; background-color: #ff708a;" class="search-toggle btnsearch btn align-end p-2" v-on:click="deletePhim()"><i class="fa-solid fa-trash-can me-2"></i><b>Xóa phim</b></button>
                </div>
            </div>
